...
public class Research_Opportunities
{
    ...
    public void setLast(Date last){this.last=last;}
    ...
    Research_Opportunities(int Research_id, String Heading,String field,String no_of_students,String discipline_of_students, int Teacher_id, String degree,  String Cgpa, String Description,String  last_date_to_apply, String Starting_date,String Category)
    {
        this. Research_id=Research_id;
        this.Heading=Heading;
        this. field=field;
    ...
    Research_Opportunities(int Research_id, String Heading,String field,String no_of_students,String discipline_of_students, int Teacher_id, String degree,  String Cgpa, String Description,Date  last, String Starting_date,String Category)
    {
        this. Research_id=Research_id;
        this.Heading=Heading;
        this. field=field;
