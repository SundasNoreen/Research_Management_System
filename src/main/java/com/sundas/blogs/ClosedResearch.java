...
public class ClosedResearch {
    ...
    ClosedResearch(int Research_Id, String Status, String Title, String Teacher, int Teacher_id, String Domain, Date Starting_Date, Date Ending_Date, String Success_Level, String Abstract, String Conclusion, Blob Report) {
    ...
    ClosedResearch(int Research_Id, String Status, String Title, String Teacher, int Teacher_id, String Students, String Domain, Date Starting_Date, Date Ending_Date, String Success_Level, String Abstract, String Conclusion, Blob Report, String Link, String Remarks) {
        this.Research_Id = Research_Id;
        this.Teacher = Teacher;
        this.Title = Title;
