...
public class Research_Tracker
{
    ...
    Research_Tracker(int Paper_Id,String Student_Id,String Name,String Title,String Author,String Domain,String Abstract,String Notes,String Conclusion,Date Publishing,Date Review)
    {
    ...
    public static void main(String[] args) throws SQLException {
        Research_Tracker obj = new Research_Tracker();
        obj.MyTrack("2019-CE-03");
    }
}
