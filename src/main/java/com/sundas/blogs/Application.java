...
public class Application {
    ...
    Application(int Application_Id, String Title, int Opportunity_Id, int Teacher_Id, String Teacher_Name, Date Submission, String Student_Id, String Name, String CGPA, String Degree, String Field, String Reason, String Status, String Semester) {
    ...
    Application(String Student_Id, String Name, int Opportunity_Id, String Title, int Teacher_Id, String Teacher_Name) {
        this.Student_Id = Student_Id;
        this.Name = Name;
        this.Title = Title;
        this.Opportunity_Id = Opportunity_Id;
